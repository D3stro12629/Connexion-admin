          ...
          <div class="title-stack">
            <h1>
              ...
              <span class="count-chip" v-if="!degreeStore.isLoading">
                {{ degreeStore.degrees?.length || 0 }} សរុប
              </span>
            </h1>
            <p class="subtitle-text">គ្រប់គ្រង និងស្តង់ដារកម្រិតវប្បធម៌</p>
          </div>
          ...
          <footer v-if="totalEntries > 0" class="premium-pagination-footer">
            <div class="pagination-left">
              <p class="entries-text">
                កំពុងបង្ហាញ <span class="mono-num">{{ showingStart }}</span>
                ដល់ <span class="mono-num">{{ showingEnd }}</span>
                នៃ <span class="mono-num total">{{ totalEntries }}</span> ទិន្នន័យសរុប
              </p>
            </div>
            ...
            <div class="modal-surface compact-modal">
              ...
              <div class="modal-content compact-padding">
                ...
                <div class="modal-footer-refined">
                  ...
                  <button class="btn-danger" :disabled="degreeStore.isProcessing" @click="confirmDelete">
                    <span v-if="degreeStore.isProcessing" class="spinner-border spinner-border-sm me-2"></span>
                    យល់ព្រម</button>
                </div>
              </div>
